...
final thinkerAuthorsProvider = Provider<AsyncValue<List<String>>>((Ref ref) {
  ...
  return allAsync.whenData((quotes) {
    final typeStr = type == ThinkerType.philosopher ? 'philosopher' : 'politician';
    final authors = quotes
...
final thinkerQuotesProvider = Provider<AsyncValue<List<ThinkerQuote>>>((Ref ref) {
